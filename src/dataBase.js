...
function deletarPokemon(id) {
    ...
    /*recebe 2 parametros o 1 é a posição do elemento que quero deletar, 
    e o segundo a quantidade de elementos que quero deletar, 
    a partir do parametro especificado*/
...
function pocaoHp(id, pokemon){
    ...
    return `Curando seu pokemon \n nome ${pokemon.nome} hp: ${pokemon.hp}`
}

module.exports = { salvarPokemons, mostrarPokemon, mostrarPokemons, atualizarPokemon, deletarPokemon, batalhaPokemon, pocaoHp }